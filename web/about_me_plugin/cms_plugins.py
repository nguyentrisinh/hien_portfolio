...
@plugin_pool.register_plugin
class AboutMeTwoComponentPlugin(CMSPluginBase):
    model = CMSPlugin
    render_template = 'about_me_plugin/plugin/about-me-2-component.html'
    cache = False

    def render(self, context, instance, placeholder):
        context = super(AboutMeTwoComponentPlugin, self).render(context, instance, placeholder)
        instance = context['instance']
